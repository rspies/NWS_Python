...
for basin_id in basin_ids:
    print basin_id
    calib_read = open(maindir + '\\'+RFC+'\\Calibration_TimeSeries\\'+sim_type+'\\QME_timeseries\\' + basin_id + '_Simulation_TimeSeries.csv', 'r') #test!!!
    # output figure directory
    out_dir = maindir + '\\'+RFC+'\\Calibration_TimeSeries\\'+sim_type
    ...
    all_bins = (('0.1,0.5',[]),('0.5,1.0',[]),('1.0,2.0',[]),('2.0,4.0',[]),('4.0,6.0',[]),('6.0,8.0',[]),('8.0,10.0',[]),
            ...
            ('500.0,800.0',[]),('800.0,1200.0',[]),('1200.0,1600.0',[]),('1600.0,2000.0',[]),('2000.0,3000.0',[]),('3000.0,5000.0',[]),('5000.0,7000.0',[]))
    ...
    z = np.polyfit(date_Q_calib, date_Q, 1)
    f = np.poly1d(z)
