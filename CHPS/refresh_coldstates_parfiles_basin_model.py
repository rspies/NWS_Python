...
# The script can rename the original ColdStateFiles directory to "ColdStateFiles_previous"
# and renames the new directory to "ColdStateFiles" if desired
...
find_par_file = 'model' # choices: 'model' or 'basin' # use this to specify the directory structure of updated_ModuleParFiles
######################### End User Input ######################################
...
for basin in os.listdir(cold_dir):
    ...
    for zip_file in os.listdir(basin_dir):
        ...
        if find_par_file == 'basin':
            add_file = param_dir + os.sep + basin + os.sep + model_name   # use basin name directory to find parfile
        if find_par_file == 'model':
            add_file = param_dir + os.sep + model + os.sep + model_name   # use model name directory to find parfile
