...
#cody.moser@amec.com
#AMEC
#Description: merges min/mean/max elevation .csv data output from ArcGIS model builder
#into a single .csv file with elevation coverted from cm to ft
...
#FOLDER PATH OF OUTPUT FILE (!Must be different than csv_FolderPath!)
