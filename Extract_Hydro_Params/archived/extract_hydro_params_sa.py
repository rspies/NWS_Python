...
folderPath = 'P:\\NWS\\chps_sa\\' + RFC.lower() + '_sa\\Config\\ModuleParFiles\\*'
#!!!!! output directory: enter ouput location of .csv file below ->
csv_file_out = 'P:\\NWS\\Reports\\LMRFC\\LMRFC_deliverables\\SAC_param_maps' + '\\Params_' + param_source
...
csv_file = open(csv_file_out +'\\' + RFC + '_UHG_Params_calb.csv', 'w')
...
csv_file = open(csv_file_out +'\\' + RFC + '_LAGK_Params_calb.csv', 'w')
