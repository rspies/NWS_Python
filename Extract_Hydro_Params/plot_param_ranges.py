...
############################### User Input ####################################
rfc = 'NCRFC_FY2016'
fx_group = 'GND' # leave blank if not processing by fx group
...
e19 = 'on' # create e19 folder with low res image for chps display

if fx_group == '':
    csv_read_init = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'Params_pre_calb' + os.sep 
    csv_read_apri = maindir + os.sep + 'GIS' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'Apriori'
    csv_file_calb = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc  + os.sep + 'Params_'+plot_type+'_calb' + os.sep + '_' + rfc + '_SACSMA_Params_'+plot_type+'_calb_slim.csv'
else:
    csv_read_init = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + fx_group + os.sep + 'Params_pre_calb' + os.sep
    csv_read_apri = maindir + os.sep + 'GIS' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'Apriori' + os.sep + fx_group 
    csv_file_calb = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + fx_group + os.sep + 'Params_'+plot_type+'_calb' + os.sep + '_' + rfc + '_SACSMA_Params_'+plot_type+'_calb_slim.csv'
############################ End User Input ###################################
...
if sac_plot == 'on':
    ...
    if plot_type == 'draft' or plot_type == 'final': 
        csv_read_calb = open(csv_file_calb, 'r')
    ...
    for basin in all_basins:
        ...
        fig.suptitle(basin + ' SAC-SMA ' + plot_type.title() + ' Parameters',y=1.02,fontsize=14)
        ...
        for param in sac_pars:
            ...
            patch = patches.PathPatch(path, facecolor='orange', lw=.5, zorder=2, alpha=0.7,)
            ax1.add_patch(patch)
            ...
            if len(data_apri)>0 and apbasin + '_sac_' + param.lower() in data_apri['Max']:
                ...
                (0., 0.)]
                path = Path(and_verts, codes)
                patch = patches.PathPatch(path, facecolor='green', lw=.5, zorder=4, alpha=0.7,)
                ax1.add_patch(patch)
            ...
            if group_limits == 'on':
                ...
                (0., 0.)]
                path = Path(and_verts, codes)
                patch = patches.PathPatch(path, facecolor='#cc66ff', lw=.5, zorder=3, alpha=0.4,)
                ax1.add_patch(patch)
            
            #### plot initial param value with red bar marker
            ax1.plot(x,data_init.loc[basin,param], color='red', markersize=20, marker='_', mew=1.6, linewidth=2, zorder=5, label = rfc + ' Initial')
            
            #### plot draft/final calb param value with blue bar marker
            if plot_type == 'draft' or plot_type == 'final':
                ax1.plot(x,data_calb.loc[basin,param], color='blue', markersize=20, marker='_', mew=1.6, linewidth=2, zorder=5, alpha = 0.7, label = rfc + ' ' + plot_type.title())
            ...
            ax1.annotate(str(data_init.loc[basin,param]), (x+.35,data_init.loc[basin,param]), fontsize='5',zorder=7)
            #### add annotated labels to data points for draft/final
            if plot_type == 'draft' or plot_type == 'final': 
                ax1.annotate(str(data_calb.loc[basin,param]), (x-0.25,data_calb.loc[basin,param]), fontsize='4.5', zorder=7, path_effects=[
            ...
            #ax1.legend(loc="center",shadow=True,fontsize=11,bbox_to_anchor=(-0.1, 1.38))
            
        print 'Saving figure...'
        if fx_group == '':
            figname = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'SACSMA' + os.sep + basin + '_sacsma_param_' + plot_type + '_analysis.png'
            basin_e19 = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'E19' + os.sep + basin + '_calb'
        else:
            figname = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + fx_group + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'SACSMA' + os.sep + basin + '_sacsma_param_' + plot_type + '_analysis.png'
            basin_e19 = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + fx_group + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'E19' + os.sep + basin + '_calb'
...
if snow_plot == 'on':
    ...
    for basin in all_basins:
        ...
        fig.suptitle(basin + ' SNOW-17 ' + plot_type.title() + ' Parameters',y=1.14,fontsize=14)
        codes = [Path.MOVETO,Path.LINETO,Path.LINETO,Path.LINETO,Path.CLOSEPOLY]
        tk = 0.3; tg = 0.2; ta = 0.1
...
#                ax1.add_patch(patch)
        ...
        print 'Saving figure...'
        if fx_group == '':
            figname = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'SNOW17' + os.sep + basin + '_snow17_param_' + plot_type + '_analysis.png'
            basin_e19 = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'E19' + os.sep + basin + '_calb'
        else:
            figname = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + fx_group + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'SNOW17' + os.sep + basin + '_snow17_param_' + plot_type + '_analysis.png'
            basin_e19 = maindir + os.sep + 'Python' + os.sep + 'Extract_Hydro_Params' + os.sep + rfc[:5] + os.sep + rfc + os.sep + fx_group + os.sep + 'param_plots' + os.sep + plot_type + os.sep + 'E19' + os.sep + basin + '_calb'
