...
maindir = os.getcwd() + os.sep + RFC + os.sep 
########### find all basin QME vs SQME .csv files ############
if len(basin_ids) == 0:
    basin_ids = []
    all_files = os.listdir(maindir + 'Calibration_TimeSeries'+ os.sep + sim_type + os.sep + 'QME_SQME' + os.sep)
...
for basin_id in basin_ids:
    print basin_id
    calib_read = open(maindir + os.sep + 'Calibration_TimeSeries' + os.sep + sim_type+ os.sep + 'QME_SQME' + os.sep + basin_id + '_Simulation_TimeSeries.csv', 'r') #test!!!
    # output figure directory
    out_dir = maindir + os.sep + 'Calibration_TimeSeries' + os.sep + sim_type + os.sep + 'raster_hydrograph_plots' + os.sep
    if basin_id == 'TNGT2':
        call_QME = 3
        call_SQME = 2
        cminb = -25; cmaxb = 25
        cmina = -1500; cmaxa =1500
    elif basin_id == 'ULRT2':
        cminb = -15; cmaxb = 15
        cmina = -1250; cmaxa = 1250
    else:
        call_QME = 3
        call_SQME = 2
        cminb = -25; cmaxb = 25
    ...
    test = pd.read_csv(calib_read,sep=',',skiprows=6,
