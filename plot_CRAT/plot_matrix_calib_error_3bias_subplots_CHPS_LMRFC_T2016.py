...
basin_ids = ['TBCM7','TNZM7','NFDA4','CIGA4','GRRA4'] # <-- use this to run specific basins
#call_QME = 2
#call_obs = 3
...
for basin_id in basin_ids:
    ...
    out_dir = maindir + RFC[:5] + os.sep + RFC + os.sep + 'Calibration_TimeSeries' + os.sep + sim_type + os.sep + 'raster_hydrograph_plots' + os.sep 
    if basin_id == 'TBCM7':
        yr_start = 1980; yr_end = 2013 #
        cminb = -100; cmaxb = 100
