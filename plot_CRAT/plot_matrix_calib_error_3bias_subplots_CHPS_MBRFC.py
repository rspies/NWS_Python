...
basin_ids = ['CBCM8','TMRM8','BDCM8','SHLM8','MRMM8','HLWM8','SHAM8','LVNM8', 'RUPM8', 'MUSM8', 'MSBM8']
#basin_ids = ['FGOG1','WORF1'] # run individual basin(s) instead of all basins above
...
fig_name = '_Bias' #' Calb Raster Analysis' or '_bias_pbias_test'
